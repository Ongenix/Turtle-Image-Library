...
<br><br>
<h2 style="color:red">PIL notes that it isn't recommended to loop over every pixel, as the pixel list will become too large. This project doesn't store every pixel but instead instantly draws them.</h2>
<br><br>
